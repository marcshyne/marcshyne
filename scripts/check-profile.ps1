...
$bannerPath = Join-Path $root "assets/trap-banner-v6.webp"
...
if ($readme -notmatch "trap-banner-v6\.webp" -or $readme -notmatch "contribution-game\.svg") { throw "README asset links are stale" }
...
"Profile assets OK: $frames blue-flash frames, discrete cell snake with sequential food"
